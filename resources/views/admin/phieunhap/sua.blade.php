                        ...
                        <div class="col">
                            ...
                            <div class="col-sm-12">
                                <select name="Quyen" id="" class="form-control" required>
                                    <option value="khachhang" @if($nguoidung->Quyen=='khachhang') selected @endif>Khách hàng</option>
                                    <option value="admin" @if($nguoidung->Quyen=='admin') selected @endif>Admin</option>
                                    <option value="kho" @if($nguoidung->Quyen=='kho') selected @endif>Kho</option>
                                    <option value="quanly" @if($nguoidung->Quyen=='quanly') selected @endif>quanly</option>
                                </select>
                            </div>
                        </div>
                    </div>
